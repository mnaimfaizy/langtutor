  ...
  return (
    <div className="flex flex-1 flex-col px-6 py-10">
      <div className="mx-auto w-full max-w-2xl space-y-10">
        <section>
          <h1 className="text-foreground text-2xl font-semibold tracking-tight">Speaking</h1>
          <p className="text-muted mt-1 text-sm">
            Pick a passage to read aloud. Your speech is transcribed by Whisper and scored against
            the reference text — requires the Mac to be reachable.
          </p>
        </section>
