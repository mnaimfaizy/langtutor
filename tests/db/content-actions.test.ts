...
const mockRepo = vi.hoisted(() => ({
  ...
  resetCardProgress: vi.fn().mockResolvedValue(undefined),
  addCollection: vi.fn().mockResolvedValue(1),
  renameCollection: vi.fn().mockResolvedValue(undefined),
  deleteCollection: vi.fn().mockResolvedValue(undefined),
  addCardToCollection: vi.fn().mockResolvedValue(undefined),
  removeCardFromCollection: vi.fn().mockResolvedValue(undefined),
  getCollections: vi.fn().mockResolvedValue([]),
  getCollectionCards: vi.fn().mockResolvedValue([]),
